  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="freebiesAlertApp.item.home.createOrEditLabel" data-cy="ItemCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Distance" id="item-distance" name="distance" data-cy="distance" type="text" />
