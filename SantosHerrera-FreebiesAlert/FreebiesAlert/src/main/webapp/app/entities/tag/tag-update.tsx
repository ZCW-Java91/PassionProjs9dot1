...
export const TagUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...tagEntity,
          items: tagEntity?.items?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="freebiesAlertApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Item" id="tag-item" data-cy="item" type="select" multiple name="items">
                <option value="" key="0" />
                {items
