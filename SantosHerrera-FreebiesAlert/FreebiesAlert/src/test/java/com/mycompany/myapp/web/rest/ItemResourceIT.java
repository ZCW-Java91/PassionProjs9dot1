...
class ItemResourceIT {
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().name(DEFAULT_NAME).price(DEFAULT_PRICE).distance(DEFAULT_DISTANCE).description(DEFAULT_DESCRIPTION);
        return item;
    }
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().name(UPDATED_NAME).price(UPDATED_PRICE).distance(UPDATED_DISTANCE).description(UPDATED_DESCRIPTION);
        return item;
    }
    ...
    void createItem() throws Exception {
        ...
        assertThat(testItem.getDistance()).isEqualTo(DEFAULT_DISTANCE);
    ...
    void putExistingItem() throws Exception {
        ...
        updatedItem.name(UPDATED_NAME).price(UPDATED_PRICE).distance(UPDATED_DISTANCE).description(UPDATED_DESCRIPTION);
        ...
        assertThat(testItem.getDistance()).isEqualTo(UPDATED_DISTANCE);
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.name(UPDATED_NAME).price(UPDATED_PRICE).distance(UPDATED_DISTANCE).description(UPDATED_DESCRIPTION);
